...
'.LR::sec($cx, ((is_array($in) && isset($in['rows'])) ? $in['rows'] : null), null, $in, true, function($cx, $in) {return '	<div class="row organization'.htmlentities((string)((is_array($in) && isset($in['css_classes'])) ? $in['css_classes'] : null), ENT_QUOTES, 'UTF-8').'">
		<div class="col-lg-12">
